...
class syntax:
    double_braces = r'\{\{([A-Za-z][A-Za-z0-9_]*)\}\}'     # {{value}}
    dollars       = r'\$\{([A-Za-z][A-Za-z0-9_]*)\}'       # ${value}
    angles        = r'<([A-Za-z][A-Za-z0-9_]*)>'           # <value>
    percents      = r'%([A-Za-z][A-Za-z0-9_]*)%'           # %value%
    at_tags       = r'@([A-Za-z][A-Za-z0-9_]*)@'           # @value@
    hash_tags     = r'#([A-Za-z][A-Za-z0-9_]*)#'           # #value#
    pipe_tags     = r'\|([A-Za-z][A-Za-z0-9_]*)\|'         # |value|
    paren_dollar  = r'\$\(([A-Za-z][A-Za-z0-9_]*)\)'       # $(value)
    colons        = r':([A-Za-z][A-Za-z0-9_]*):'           # :value:
